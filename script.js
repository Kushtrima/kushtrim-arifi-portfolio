...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Stplaner Image Scroll-Linked Reveal - Images move from bottom as you scroll
    const stplanerImages = document.querySelectorAll('.stplaner-image-reveal');
    
    if (stplanerImages.length > 0) {
        let ticking = false;
